...
<div class="Text">
    ...
    <p class="paragraph">
        I am a final year student at IIT Ropar pursuing bachelor of technology in Electrical Engineering. I Interned at BlueStacks in 2024. I love working on task automation, scripting and making backend systems for web applications. I am the creator of the Javascript framework <a href="https://www.npmjs.com/package/pre-reactjs" class="link">pre-reactJS<span class="bar"></span></a> that is powering this website. Pre-reactJS is a SPA(single page applications) development javascript framework with 500+ all time downloads. Most of my work is open sourced and publicly available on my
